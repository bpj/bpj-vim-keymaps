...
m-	མ  " U+0F58 TIBETAN LETTER MA
c	ཙ  " U+0F59 TIBETAN LETTER TSA
c-	ཙ  " U+0F59 TIBETAN LETTER TSA
ch	ཚ  " U+0F5A TIBETAN LETTER TSHA
ch-	ཚ  " U+0F5A TIBETAN LETTER TSHA
j	ཛ  " U+0F5B TIBETAN LETTER DZA
j-	ཛ  " U+0F5B TIBETAN LETTER DZA
...
A-	ཨ  " U+0F68 TIBETAN LETTER A
k\"S	ཀྵ  " U+0F69 TIBETAN LETTER KSSA
k\"S-	ཀྵ  " U+0F69 TIBETAN LETTER KSSA
...
[+lce-tsa-can]	<char-0x0F8D> " ◌ྍ  " U+0F8D TIBETAN SUBJOINED SIGN LCE TSA CAN
[+mchu-can]	<char-0x0F8E> " ◌ྎ  " U+0F8E TIBETAN SUBJOINED SIGN MCHU CAN
[+inverted-mchu-can]	<char-0x0F8F> " ◌ྏ  " U+0F8F TIBETAN SUBJOINED SIGN INVERTED MCHU CAN
...
+c	<char-0x0FA9> " ◌ྩ  " U+0FA9 TIBETAN SUBJOINED LETTER TSA
Rc	ར<char-0x0FA9> " ◌ྩ  " U+0FA9 TIBETAN SUBJOINED LETTER TSA
sc	ས<char-0x0FA9> " ◌ྩ  " U+0FA9 TIBETAN SUBJOINED LETTER TSA
+ch	<char-0x0FAA> " ◌ྪ  " U+0FAA TIBETAN SUBJOINED LETTER TSHA
+j	<char-0x0FAB> " ◌ྫ  " U+0FAB TIBETAN SUBJOINED LETTER DZA
Rj	ར<char-0x0FAB> " ◌ྫ  " U+0FAB TIBETAN SUBJOINED LETTER DZA
+jh	<char-0x0FAC> " ◌ྫྷ  " U+0FAC TIBETAN SUBJOINED LETTER DZHA
w	<char-0x0FAD> " ◌ྭ  " U+0FAD TIBETAN SUBJOINED LETTER WA
+Z	<char-0x0FAE> " ◌ྮ  " U+0FAE TIBETAN SUBJOINED LETTER ZHA
+z	<char-0x0FAF> " ◌ྯ  " U+0FAF TIBETAN SUBJOINED LETTER ZA
+a	<char-0x0FB0> " ◌ྰ  " U+0FB0 TIBETAN SUBJOINED LETTER -A
...
+S	<char-0x0FB4> " ◌ྴ  " U+0FB4 TIBETAN SUBJOINED LETTER SHA
...
+k\"S	<char-0x0FB9> " ◌ྐྵ  " U+0FB9 TIBETAN SUBJOINED LETTER KSSA
